...
from routers import compare, corbeille, documents, duplicates, export, extract, folders, generate, organize, presentations, prompts, search, sources, system, templates, upload
