...
from routers import assistant, audit, bookstack, compare, connectors, corbeille, documents, dossiers, duplicates, emploi_domicile, emploi_domicile_contrats, emploi_domicile_journal, emploi_domicile_visites, export, extract, fiscalite, folders, generate, huggingface, jobs, links, maison, organize, passerelle, presentations, prompts, rapports, regroupements, search, sources, system, templates, upload, wiki
...
app.include_router(links.router,      prefix=API_PREFIX, tags=["Liens"])
...
app.include_router(emploi_domicile.router, prefix=API_PREFIX, tags=["Emploi à domicile"])
...
app.include_router(wiki.router,       prefix=API_PREFIX, tags=["Wiki"])
...
app.include_router(huggingface.router, prefix=API_PREFIX, tags=["HuggingFace"])
